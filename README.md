...
[![2.1.4-py3.12-bullseye badge](https://img.shields.io/docker/v/biggates/poetry/2.1.4-py3.12-bullseye?label=biggates%2Fpoetry&logo=docker) ![2.1.4-py3.12-slim badge](https://img.shields.io/docker/v/biggates/poetry/2.1.4-py3.12-slim?label=biggates%2Fpoetry&logo=docker) ![2.1.4-py3.11-slim badge](https://img.shields.io/docker/v/biggates/poetry/2.1.4-py3.11-slim?label=biggates%2Fpoetry&logo=docker) ![2.1.4-py3.10-bullseye badge](https://img.shields.io/docker/v/biggates/poetry/2.1.4-py3.10-bullseye?label=biggates%2Fpoetry&logo=docker) ![2.1.4-py3.10-slim badge](https://img.shields.io/docker/v/biggates/poetry/2.1.4-py3.10-slim?label=biggates%2Fpoetry&logo=docker)](https://hub.docker.com/r/biggates/poetry) [![Docker Publish Badge](https://github.com/biggates/poetry-docker/actions/workflows/docker-publish.yml/badge.svg?branch=master)](https://github.com/biggates/poetry-docker/actions/workflows/docker-publish.yml)

a Docker image that includes [Poetry](https://python-poetry.org/) for CI/CD pipelines.

## Supported tags

- `2.1.4-py3.13-bookworm`
- `2.1.4-py3.13-slim`
- `2.1.4-py3.12-bullseye`
- `2.1.4-py3.12-slim`
- `2.1.4-py3.11-slim`
- `2.1.4-py3.10-bullseye`
- `2.1.4-py3.10-slim`
